...
print("=" * 70)
print("使用 Qwen Max API 分析第一课（元首课）- 修复版")
print("=" * 70)
    ...
    if response.status_code == 200:
        ...
        if json_match:
            ...
            try:
                ...
                # 保存结果
                output_path = r'd:\新建文件夹\仪度六壬择日\yiduluren\zongmen\pdf_extract\64_ke_full\qwen_analysis\lesson_01_analyzed.json'
        ...
        # 保存原始结果
        output_path_txt = r'd:\新建文件夹\仪度六壬择日\yiduluren\zongmen\pdf_extract\64_ke_full\qwen_analysis\lesson_01_raw.txt'
        with open(output_path_txt, 'w', encoding='utf-8') as f:
            f.write(result)
        print(f"✓ 原始结果已保存：{output_path_txt}")
