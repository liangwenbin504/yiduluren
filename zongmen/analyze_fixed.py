...
def main():
    ...
    for i, line in enumerate(lines):
        ...
        # 精确匹配"第 X 课"
        if re.match(r'^第 [一二三四五六七八九十百千\d]+课$', line_stripped):
    ...
    json_path = os.path.join(OUTPUT_DIR, '64_lessons_final.json')
    ...
    # 生成 Markdown 表格
    md_path = os.path.join(OUTPUT_DIR, '64_lessons_final_table.md')
