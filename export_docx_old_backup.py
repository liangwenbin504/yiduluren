    ...
    try:
        ...
        try:
            ...
            def add_paragraph(text, font_size=16, alignment=2):
                ...
                last_para.Range.Font.Name = "李白赋诗游龙惊鸿"
                last_para.Range.Font.NameFarEast = "李白赋诗游龙惊鸿"
            ...
            # 终极保险：重新打开，最后确认一次！
            # ========================================
            print("🔒 终极保险：重新打开文档，最终确认...")
            final_doc = word.Documents.Open(os.path.abspath(output_path))
            force_all_pictures_float_above_text(final_doc, word)
            final_doc.Save()
            final_doc.Close()
            print("✅ 终极保险完成")
